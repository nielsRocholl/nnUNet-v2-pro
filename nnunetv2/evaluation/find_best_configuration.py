...
def find_best_configuration_entry_point():
    ...
    parser.add_argument('-c', nargs='+', required=False, default=['3d_fullres', '3d_lowres', '3d_cascade_fullres'],
                        help="List of configurations. Default: ['3d_fullres', '3d_lowres', '3d_cascade_fullres']")
